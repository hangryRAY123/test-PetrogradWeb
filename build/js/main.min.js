...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var video = document.querySelector(".demo__inner--video video");
  var body = document.querySelector("body");
  var nav = document.querySelector(".nav");
  var wrapper = document.querySelector(".wrapper");
  var toggle = document.querySelector(".btn-toggle");
  var playBtn = document.querySelector(".demo__btn--play");
  ...
  _gsapMin.gsap.registerPlugin(_ScrollTriggerMin.ScrollTrigger, _ScrollToPluginMin.ScrollToPlugin);

  // creeping line

  _gsapMin.gsap.set(".box", {
    x: function x(i) {
      return i * 750;
    }
  });
  _gsapMin.gsap.to(".box", {
    duration: 20,
    ease: "none",
    x: "+=7500",
    // move each box 500px to right
    modifiers: {
      x: _gsapMin.gsap.utils.unitize(function (x) {
        return parseFloat(x) % 7500;
      }) // force x value to be between 0 and 500 using modulus
    },
    repeat: -1
  });
  _gsapMin.gsap.set(".box-reverse", {
    x: function x(i) {
      return i * -750;
    }
  });
  _gsapMin.gsap.to(".box-reverse", {
    duration: 20,
    ease: "none",
    x: "-=7500",
    // move each box 500px to right
  ...
  _gsapMin.gsap.set(".box-video", {
    x: function x(i) {
      return i * 430;
    }
  });
  _gsapMin.gsap.to(".box-video", {
    duration: 10,
    ease: "none",
    x: "+=4300",
    // move each box 500px to right
    modifiers: {
      x: _gsapMin.gsap.utils.unitize(function (x) {
        return parseFloat(x) % 4300;
      }) // force x value to be between 0 and 500 using modulus
    },
    repeat: -1
  });
  _gsapMin.gsap.set(".box-video-reverse", {
    x: function x(i) {
      return i * -430;
    }
  });
  _gsapMin.gsap.to(".box-video-reverse", {
    duration: 10,
    ease: "none",
    x: "-=4300",
    // move each box 500px to right
  ...
  var panels = _gsapMin.gsap.utils.toArray(".scroll-section"),
    observer = _ScrollTriggerMin.ScrollTrigger.normalizeScroll(true),
    scrollTween;
  ...
  panels.forEach(function (panel) {
    _ScrollTriggerMin.ScrollTrigger.create({
      ...
      onToggle: function onToggle(self) {
        return self.isActive && !scrollTween && goToSection(panel);
      },
  ...
  var videoTimeline = _gsapMin.gsap.timeline({
    paused: true
  });
  var bikeTimeline = _gsapMin.gsap.timeline({
    paused: true
  });
  videoTimeline.fromTo(".demo__inner--video", {
    yPercent: 100,
    rotation: 90,
    duration: 2,
    ease: "power2.out"
  ...
  bikeTimeline.fromTo(".demo__inner--bike", {
    yPercent: 100,
    rotation: 90,
    duration: 2,
    ease: "power2.out"
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13,"./vendor/gsap/ScrollToPlugin.min.js":15,"./vendor/gsap/ScrollTrigger.min.js":16,"./vendor/gsap/gsap.min.js":17}],2:[function(require,module,exports){
"use strict";
  ...
  return _createClass(Form, [{
    ...
    value: function _onFormSubmit(event) {
      ...
      if (this.validateForm(event.target) && callback) {
        var formSuccess = document.querySelector('.request__success');
        setTimeout(function () {
